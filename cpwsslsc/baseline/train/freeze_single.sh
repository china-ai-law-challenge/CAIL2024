...
${OPTIONS_NCCL} deepspeed --master_port=${PORT} LexiLaw/src/finetune_freeze.py \
    --train_path dataDeal/train_random.json \
    --max_len 2048 \
    --max_input_len 1800 \
    --model_name_or_path LexiLaw/model \
    --tokenizer_name LexiLaw/model \
    --lora_rank 8 \
    ...
    --logging_steps 50 \
    --output_dir model_checkpoints2409051903 \
    --deepspeed LexiLaw/src/ds_config.json \
