...
**请参赛选手在（12月1日 00:00 - 12月5日 24:00）准备并测试推理服务API（已提供格式校验程序），请在（12月6日 00:00 - 12月7日 24:00）正式提交接口，我们将在（12月8日 00:00 - 12月9日 24:00，务必保证接口可调用）集中调用接口，请保证接口的稳定性，我们将同步安排人工打分。**
