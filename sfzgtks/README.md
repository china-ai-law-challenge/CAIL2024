...
***（注意：复赛增加了比赛难度，要求参赛选手提交答案尽可能简练（不超过标准答案长度两倍），否则可能截断答案导致提交不完整。）***
...
请在（12月1日 00:00 - 12月5日 24:00）准备并测试您的API，在（12月6日 00:00 - 12月8日 24:00）正式提交（**一次提交机会**），我们将在12月9日起对提交的有效答案进行人工打分。
...
result = response.json()
```
- 封测提交时间：12月6日 00:00 - 12月8日 24:00
